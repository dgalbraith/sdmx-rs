...
<!-- GUIDANCE:
  ...
  constraints/requirements driving it. Cover:
    ...
    - the goals and the success criteria the design must meet.
...
<!-- GUIDANCE:
  ...
  Use [Open] or [Resolved] as the status label, followed by a bold
  headline and prose. Record the resolution inline once answered.
-->

- **[Open]** - **Headline**: <!-- e.g. How does this interact with the streaming parser's lifetime bounds? -->
...
* <!-- e.g. [ADR-0XYZ: title](../../adr/0XYZ-title.md), [GitHub issue #N] -->
...
<!-- GUIDANCE:
  (Optional, for accepted designs) Hand-off detail for whoever implements this:
    ...
    - estimated effort or phasing.
  Delete this section while the design is still Proposed.
-->
